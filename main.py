...
combinedData = fumbleDataHelper.calculateXperY(combinedData, 'Fumbles Per Carry', 'Fumbles', 'Rushing Attempts')
combinedData = fumbleDataHelper.calculateXperY(combinedData, 'Fumbles Per Yard', 'Fumbles', 'Rushing Yards')
